...
function SideBar() {
  ...
  const menuItems = [
    ...
    { text: "Teachers", icon: <PeopleOutlinedIcon />, path: "/ViewTeachers" },
    { text: "Students", icon: <GroupIconOutlinedIcon />, path: "/ViewStudents" },
    { text: "Books", icon: <LibraryBookOutlinedIsIcon />, path: "/Books" },
    { text: "Reports", icon: <BarChartOutlinedIcon />, path: "/Reports" },
  ];
