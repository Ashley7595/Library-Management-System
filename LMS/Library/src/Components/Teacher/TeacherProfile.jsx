    ...
    <Box p={2} mt={5}>
      ...
      >
        ...
        >
          ...
          >
            <img
              src={`http://localhost:5001/teacher/${profile.image}`}
              alt={profile?.fname}
              style={{
                width: "100%",
                height: "350px", 
          ...
          >
            {[
              ...
              <Typography key={i} variant="h6" fontWeight="600" color={colors.grey[100]} letterSpacing={1}>
            ...
            <Box mt={2}>
              <Button
                onClick={() => navigate('/EditTeacherProfile/:id')}
                sx={{
